...
class Clyde:
    ...
    #A method to return the boolean for Clyde's movement
    ...
    def frame_update(self):
        ...
        if(self.frightened_state_v1):
            #Debug code
                #print('Clyde is in a frightened state #1')
        ...
        #Frightened state #2 (a pattern of repeating blue and white version of the ghost)
            ...
            #Debug code
                #print('Clyde is in a frightened state #2')
        ...
        #A state where the ghost is a pair of floating eyes
            ...
            #Debug code
                #print('Clyde is in an eaten state')
