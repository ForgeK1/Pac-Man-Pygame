...
class Clyde:
    ...
    #A method to return a boolean for Clyde's vulnerable state version #1
    def get_vulnerable_state_v1(self):
        return self.vulnerable_state_v1

    #A method to set a new boolean for Clyde's  vulnerable state version #1
    def set_vulnerable_state_v1(self, new_vulnerable_state_v1):
        self.vulnerable_state_v1 = new_vulnerable_state_v1

    #A method to return a boolean for Clyde's vulnerable state version #2
    def get_vulnerable_state_v2(self):
        return self.vulnerable_state_v2

    #A method to set a new boolean for Clyde's vulnerable state version #2
    ...
    def frame_update(self):
        ...
        if(self.vulnerable_state_v1):
            #Debug code
                #print('Clyde is in a vulnerable state #1')
        ...
        #Vulnerable state #2 (a pattern of repeating blue and white version of the ghost)
            ...
            #Debug code
                #print('Clyde is in a vulnerable state #2')
