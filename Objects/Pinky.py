...
class Pinky:
    ...
    #A method to return a boolean for Pinky's movement
    ...
    def frame_update(self):
        ...
        if(self.vulnerable_state_v1):
            #Debug code
                #print('Pinky is in a vulnerable state #1')
        ...
        #Vulnerable state #2 (a pattern of repeating blue and white version of the ghost)
            ...
            #Debug code
                #print('Pinky is in a vulnerable state #2')
    ...
    #A method for the player to control Pinky's movement position
