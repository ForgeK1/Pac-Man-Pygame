...
class MainMenuScene:
    ...
    def __init__(self, display_surface, game_state_manager, WINDOW_WIDTH, WINDOW_HEIGHT):        
        ...
        self.pac_man = PacMan(70, 70, "Right", 320, 270, True, 100)
        self.blinky = Blinky(70, 70, "Right", 80, 220, True, 100, None, self.game_state_manager)
        self.pinky = Pinky(70, 70, "Right", 180, 220, True, 100, None, self.game_state_manager)
        self.inky = Inky(70, 70, "Right", 80, 320, True, 100, None, self.game_state_manager)
        self.clyde = Clyde(70, 70, "Right", 180, 320, True, 100, None, self.game_state_manager)
